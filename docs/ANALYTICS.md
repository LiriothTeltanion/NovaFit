...
This document defines every metric and visualization used by NovaFit Ultimate 4.0. The goal is reproducibility: another developer should be able to read the stored rows, follow the formulas and reach the same result.
